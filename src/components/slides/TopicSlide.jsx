...
const TopicSlide = ({ topicIndex, isActive, onQuestionOpen, bgVideo }) => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-black">
      ...
      <div key={activationCount} className="relative z-[2] flex min-h-0 flex-1 flex-col px-[5%] pt-[3%] pb-[5%]">
        <div className="max-w-full md:max-w-[65%]">
          ...
          <h2 className="mt-1 text-white leading-[1.04]" style={{ fontSize: 'clamp(20px, 3.5vw, 56px)' }}>
        ...
        <div
          className="scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/20 mt-8 grid min-h-0 flex-1 content-start gap-3 overflow-y-auto pr-1 pb-2"
